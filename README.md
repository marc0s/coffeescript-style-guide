...
Use **tabs**, one per indentation level. You may use spaces for allignment.
...
Explicitly add parentheses for functions that take no arguments to improve readability:
